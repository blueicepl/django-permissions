...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'permissions_permission_content_types')
        ...
        db.create_unique(m2m_table_name, ['permission_id', 'contenttype_id'])

        # Adding model 'ObjectPermission'
        db.create_table(u'permissions_objectpermission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'permissions', ['ObjectPermission'])

        # Adding model 'ObjectPermissionInheritanceBlock'
        db.create_table(u'permissions_objectpermissioninheritanceblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['permissions.Permission'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('content_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'permissions', ['ObjectPermissionInheritanceBlock'])

        # Adding model 'Role'
        db.create_table(u'permissions_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('codename', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'permissions', ['Role'])

        # Adding M2M table for field global_permissions on 'Role'
        m2m_table_name = db.shorten_name(u'permissions_role_global_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('role', models.ForeignKey(orm[u'permissions.role'], null=False)),
            ('permission', models.ForeignKey(orm[u'permissions.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['role_id', 'permission_id'])

        # Adding model 'PrincipalRoleRelation'
        db.create_table(u'permissions_principalrolerelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'permissions', ['PrincipalRoleRelation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'permissions_permission_content_types'))

        # Deleting model 'ObjectPermission'
        db.delete_table(u'permissions_objectpermission')

        # Deleting model 'ObjectPermissionInheritanceBlock'
        db.delete_table(u'permissions_objectpermissioninheritanceblock')

        # Deleting model 'Role'
        db.delete_table(u'permissions_role')

        # Removing M2M table for field global_permissions on 'Role'
        db.delete_table(db.shorten_name(u'permissions_role_global_permissions'))

        # Deleting model 'PrincipalRoleRelation'
        db.delete_table(u'permissions_principalrolerelation')
    ...
    models = {
        ...
        u'permissions.objectpermission': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['permissions.Role']", 'null': 'True', 'blank': 'True'})
        },
        u'permissions.objectpermissioninheritanceblock': {
        ...
        u'permissions.principalrolerelation': {
